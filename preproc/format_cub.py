...
pp.add_argument('--load-path', type=str, default='../datasets/cub',
                help='Path to a directory containing a copy of the CUB dataset.')
pp.add_argument('--save-path', type=str, default='../datasets/cub', help='Path to output directory.')
args = pp.parse_args()
