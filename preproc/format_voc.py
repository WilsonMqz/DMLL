...
pp.add_argument('--load-path', type=str, default='D:\datasets\mll_datasets/voc',
                help='Path to a directory containing a copy of the VOC dataset.')
pp.add_argument('--save-path', type=str, default='D:\datasets\mll_datasets/voc', help='Path to output directory.')
args = pp.parse_args()
